...
exports.determineResponsibleOfficer = void 0;
const prisma_js_1 = require("../prisma.js");
const determineResponsibleOfficer = async (criteria) => {
    ...
    let department = await prisma_js_1.prisma.department.findFirst({
        where: {
    ...
    if (!department) {
        ...
        department = await prisma_js_1.prisma.department.findFirst({
    ...
    let officer = null;
    if (department) {
        officer = await prisma_js_1.prisma.user.findFirst({
            where: {
                mineId: criteria.mineId,
...
exports.determineResponsibleOfficer = determineResponsibleOfficer;
